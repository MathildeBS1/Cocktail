...
DATASET_PATH = os.path.join("/Users/mathildebrinchsorensen/Desktop/DIS/GreenGroceries/GreenGroceries/dataset/cocktail.csv")
...
UserTypeChoices = ModelChoices(['Bartender', 'Customer'])
